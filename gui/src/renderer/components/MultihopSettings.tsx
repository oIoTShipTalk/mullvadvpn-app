          ...
          <NavigationContainer>
            ...
            <NavigationScrollbars>
              <SettingsHeader>
                ...
                <HeaderSubTitle>
                  {messages.pgettext('wireguard-settings-view', 'Can only be used with WireGuard.')}
                </HeaderSubTitle>
              </SettingsHeader>
...
function featureUnavailableMessage() {
  ...
  return sprintf(
    messages.pgettext(
      'wireguard-settings-view',
      'Switch to “%(wireguard)s” or “%(automatic)s” in Settings > %(tunnelProtocol)s to make %(multihop)s available.',
    ),
    { wireguard: strings.wireguard, automatic, tunnelProtocol, multihop },
  );
}
