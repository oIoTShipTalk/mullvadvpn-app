...
pub const ALLOWED_LAN_MULTICAST_NETS: [IpNetwork; 8] = [
    ...
    IpNetwork::V6(
        Ipv6Network::new_checked(Ipv6Addr::new(0xff01, 0, 0, 0, 0, 0, 0, 0), 16).unwrap(),
    ),
    // Link-local IPv6 multicast. IPv6 equivalent of 224.0.0.0/24
    IpNetwork::V6(
        Ipv6Network::new_checked(Ipv6Addr::new(0xff02, 0, 0, 0, 0, 0, 0, 0), 16).unwrap(),
    ),
    // Realm-local IPv6 multicast.
    IpNetwork::V6(
        Ipv6Network::new_checked(Ipv6Addr::new(0xff03, 0, 0, 0, 0, 0, 0, 0), 16).unwrap(),
    ),
    // Admin-local IPv6 multicast.
    IpNetwork::V6(
        Ipv6Network::new_checked(Ipv6Addr::new(0xff04, 0, 0, 0, 0, 0, 0, 0), 16).unwrap(),
    ),
    // Site-local IPv6 multicast.
    IpNetwork::V6(
        Ipv6Network::new_checked(Ipv6Addr::new(0xff05, 0, 0, 0, 0, 0, 0, 0), 16).unwrap(),
    ),
];
