...
# panic = 'abort'
#
# We cannot set the above directly in Cargo.toml since it must be set for the entire workspace.
...
RUSTFLAGS=$RUSTFLAGS cargo run --bin installer-downloader --release
